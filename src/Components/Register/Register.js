...
const Register = () => {
    ...
    return (
        <div>
            <div className="mx-5">
                <h2 className="text-info text-center">Please {isLogin ? 'Login' : 'Register'} </h2>
                <form onSubmit={handleRegistration}>
                    <div className="form-group row">
                        <label htmlFor="inputEmail3" className="col-sm-2 col-form-label">Your Email</label>
                ...
                <br />
                <p className="">Already have account? Please <Link to="/login">Login</Link> </p>
                <br />
                <p>---------</p>
                <button type="button" onClick={handleGoogleSignIn} className="btn btn-warning ">Google Sign In</button>
            </div>
        </div>
    );
};
